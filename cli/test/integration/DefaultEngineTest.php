...
class DefaultEngineTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function versionProvider()
    {
        return array(
            ...
            // 3.x
            array('Twig 3.x', 'Twig-3.10.3'),
            array('Twig 3.x', 'Twig-3.10.2'),
            array('Twig 3.x', 'Twig-3.10.1'),
            array('Twig 3.x', 'Twig-3.10.0'),
            array('Twig 3.x', 'Twig-3.9.3'),
            array('Twig 3.x', 'Twig-3.9.2'),
            array('Twig 3.x', 'Twig-3.9.1'),
            array('Twig 3.x', 'Twig-3.9.0'),
